...
@WebServlet("/upload_professional_service")
public class UploadProfessionalService extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException{
        ...
        serviceService.createService(professional,serviceProfessionalTO.getServiceTO());
